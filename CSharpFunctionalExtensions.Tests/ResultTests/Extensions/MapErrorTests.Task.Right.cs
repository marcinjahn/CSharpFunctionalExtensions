...
namespace CSharpFunctionalExtensions.Tests.ResultTests.Extensions
{
    public class MapErrorTests_Task_Right : TestBase
    {
        ...
        [Fact]
        public async Task MapError_Task_Right_with_context_returns_new_failure()
        {
        ...
        [Fact]
        public async Task MapError_Task_Right_with_context_returns_new_UnitResult_failure()
        {
            Result result = Result.Failure(ErrorMessage);
            var invocations = 0;
        ...
        [Fact]
        public async Task MapError_Task_Right_T_with_context_returns_new_failure()
        {
        ...
        [Fact]
        public async Task MapError_Task_Right_UnitResult_with_context_returns_new_failure()
        {
        ...
        [Fact]
        public async Task MapError_Task_Right_E_UnitResult_with_context_returns_new_failure()
        {
            UnitResult<E> result = UnitResult.Failure(E.Value);
            var invocations = 0;
        ...
        [Fact]
        public async Task MapError_Task_Right_T_E_with_context_returns_new_failure()
        {
            Result<T> result = Result.Failure<T>(ErrorMessage);
            var invocations = 0;
        ...
        [Fact]
        public async Task MapError_Task_Right_T_E_E2_with_context_returns_new_failure()
        {
